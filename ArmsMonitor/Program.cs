    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                ////TmServerに記録する
                //ArmsApi.Model.Software.UpdateArmsMonitorSystemVersion(Application.ProductVersion, configUpdatefg);

                ////設定ファイルのバージョンとClickOnceのバージョンに不整合がある場合はエラー終了
                //string[] clickOnceVersion = Application.ProductVersion.Split('.');
                //string[] configVersion = ArmsApi.Config.Settings.ArmsMonitorSystemVersion.Split('.');
