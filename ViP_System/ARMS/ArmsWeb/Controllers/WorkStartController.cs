...
{
    public class WorkStartController : Controller
    {
        //
        // GET: /WorkStart/
        ...
        /// カット工程　ブレンド可能ロット検索機能
        /// </summary>
        private void searchRecommend(ArmsApi.Model.Magazine first, WorkStartModel m)
        {
            try
            {
