...
#Region "関数"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function fncMatLPRT(ByVal pslabelkb As String,
                               ByVal pslabelno As String,
                               ByVal pslotno As String,
                               ByVal psmaterialnm As String) As Boolean
        ...
        Try
            ...
            If bRet Then
                'バーコード編集
                sBC = pslabelkb & " " & pslabelno & " " & pslotno

                'テンプレートファイルへ転送
                ObjDoc.GetObject("materialnm").Text = psmaterialnm                          '材料名
