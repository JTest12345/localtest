...
namespace ArmsWorkTransparency.Model.PLC
{
    public class MachinePLC 
    {
        ...
        /// Singletonインスタンス
        /// </summary>
        //private static MachinePLC instance;
        //private MachinePLC instance;
        ...
        //public static MachinePLC GetInstance()
        //{
        //    if (instance == null)
        //    {
        //        instance = new MachinePLC();
        ...
        private bool Ping(string host, int timeout, int retryTimes)
        {
            // Pingオブジェクトの作成
        ...
        public string GetBit(string hexAddressWithDeviceNM, string address, int port)
        {
            ...
            else
            {
                ...
                return MachinePLC.BIT_READ_TIMEOUT_VALUE;
            }
        }
        ...
        public string[] GetWord(string hexAddressWithDeviceNM, int points, string address, int port)
        {
            ...
            else
            {
                //異常終了
                //Log.WriteError("PLCエラー応答:" + command);
                return MachinePLC.BIT_READ_TIMEOUT_VALUE_ARRAY;
            }
        }
		...
		public int? GetWordAsDecimalData(string hexAddressWithDeviceNM, string address, int port)
        {
            ...
            try
            {
                retv = int.Parse(GetWord(hexAddressWithDeviceNM, address, port));
            }
            catch
            {
                return null;
        ...
        public string GetMagazineNo(string hexAddressWithDeviceNm, bool notDevided, string host, int port, int wordLength)
        {
            ...
            if (org == MachinePLC.BIT_READ_TIMEOUT_VALUE_ARRAY)
            {
                return string.Empty;
            }
        ...
        /// <param name="host"></param>
        /// <returns></returns>
        public string GetString(string hexAddressWithDeviceNm, int wordLength, string host, int port)
        {
