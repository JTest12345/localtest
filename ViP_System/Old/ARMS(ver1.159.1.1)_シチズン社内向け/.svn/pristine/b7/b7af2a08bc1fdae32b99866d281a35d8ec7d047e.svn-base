...
{
    public class RelayMachinePLC : IPLC
    {
        public string IPAddress { get; set; }
        public int Port { get; set; }

        public MachinePLC Plc { get; set; }

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public RelayMachinePLC(string address, int port) 
        {
            this.IPAddress = address;
            this.Port = port;

            //Plc = MachinePLC.GetInstance();
            Plc = new MachinePLC();
        }
        ...
        {
            return Plc.GetMagazineNo(hexAddressWithDeviceNm, notDevided, this.IPAddress, this.Port, MachinePLC.MAGAZINE_NO_WORD_LENGTH);
        }
		...
		{
			return GetMachineNo(hexAddressWithDeviceNm, MachinePLC.MACHINE_NO_WORD_LENGTH);
		}
        ...
        {
            return Plc.GetString(hexAddressWithDeviceNm, wordLength, this.IPAddress, this.Port);
        }
        ...
        {
			return Plc.GetWordAsDecimalData(hexAddressWithDeviceNM, this.IPAddress, this.Port).Value;
        }
