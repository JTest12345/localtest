...
{
	public class DieBonder5 : DieBonder2
	{
        /// <summary>
        ...
        /// <summary>
        /// ダイボンダー AD838Lのバッファを利用するタイプ　※ウェハーチェンジャーは無し
		...
		public override void WorkCompleteHigh()
		{
			...
			if (this.LogOutputDirectoryPath != null)
			{
				...
				if (string.IsNullOrEmpty(lFile))
					throw new ApplicationException(string.Format("Lファイルの取得失敗 LotNo:{0}", lot.NascaLotNo));
