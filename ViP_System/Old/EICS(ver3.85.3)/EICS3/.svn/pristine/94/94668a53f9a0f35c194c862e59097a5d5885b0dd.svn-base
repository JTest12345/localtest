...
namespace EICS
{
	public partial class SettingInfo
	{
        ...
        //<--後工程合理化/エラー集計
        // 後工程合理化のST/TPのファイル監視周期(デフォルト:30分)
        const int DEFAULT_ST_WAIT_SEC = 1800;
        //-->後工程合理化/エラー集計
		...
		/// <summary>このPCでLENS2ソフトを使用フラグ</summary>
		public bool LensFG { get; set; }
		...
		/// <summary>MMファイルLENSコピー作成場所(WB)</summary>
        ...
        /// <summary>ARMSデータベース接続文字列</summary>
        public string ArmsConnectionString { get; set; }

        /// <summary>EICSデータベース接続文字列</summary>
        public string EicsConnectionString { get; set; }

        /// <summary>LENSデータベース接続文字列</summary>
        ...
        //オーブン温度管理システム用の接続文字列。PINKリフロー用
        public string OvenTemparatureControlConnectionString { get; set; }
