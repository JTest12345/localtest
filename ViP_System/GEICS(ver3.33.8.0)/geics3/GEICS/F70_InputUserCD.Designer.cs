namespace GEICS
{
	partial class F70_InputUserCD
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "更新者の従業員番号を入力して下さい。";
			// 
			// txtUserCD
			// 
			this.txtUserCD.Location = new System.Drawing.Point(112, 24);
			this.txtUserCD.MaxLength = 8;
			this.txtUserCD.Name = "txtUserCD";
			this.txtUserCD.Size = new System.Drawing.Size(100, 19);
			this.txtUserCD.TabIndex = 1;
			this.txtUserCD.WordWrap = false;
			// 
			// btnOK
			// 
			this.btnOK.Location = new System.Drawing.Point(137, 49);
			...
			this.Name = "F70_InputUserCD";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "F70_InputUserCD";
			this.TopMost = true;
