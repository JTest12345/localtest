...
namespace VSPMasterMaintenance
{
    public class SQLite
    {
        static SQLite()
        {
            ConStr = "server=VAUTOM4\\SQLExpress;Connect Timeout=30;Application Name=ARMS;UID=inline;PWD=R28uHta;database=ARMS;Max Pool Size=100"; ;//Config.Settings.LocalConnString;
        }
