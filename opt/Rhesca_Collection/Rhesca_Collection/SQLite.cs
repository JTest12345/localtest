    ...
    public class SQLite {
        ...
        public class AddSqlData {
            ...
            public string InsertString {
                get {
                    //string型は''で囲む
                    //機種　LotNo　測定者　設備No　日時　測定箇所　測定項目　測定値　破壊モード　判定　測定器シリアル
                    string s = $"'{Product}','{LotNo}','{OperatorNo}',{Machine},'{DateTime}','{Place}','{Item}',{Data},'{Mode}','{Judge}','{MeasureSerial}'";
                    return s;
                }
            }
            ...
            public AddSqlData(string product, string lotno, string ope, string machine, string dt, string place, string item, string data, string mode, string judge, string measure_serial) {
                Product = product;
                LotNo = lotno;
                OperatorNo = ope;
