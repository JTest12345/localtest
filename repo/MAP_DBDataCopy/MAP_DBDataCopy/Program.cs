...
namespace MAP_DBDataCopy
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string yyyymm;
            yyyymm = DateTime.Now.AddDays(-1).ToString("yyyyMM");

            Program obj = new Program();           

            //J1 192.168.5.1 - 192.168.5.10
            //J2 192.168.5.11 - 192.168.5.30
            for (int m = 1; m <= 30; m++)
            {
                ffrom = @"\\192.168.5.";
            ...
            //J3 192.168.5.121 - 192.168.5.130
            //J4 192.168.5.131 - 192.168.5.140
        ...
        public void CopyTest(string ffrom)
        {
            ...
            string folderTo = @"\\cejfs0.citizen.local\ToCEJFS1(X線データ）\Iファイル";
            ...
            foldersFrom.Clear();
            foldersTo.Clear();
            folderTo = @"\\cejfs0.citizen.local\ToCEJFS1(X線データ）\Eファイル";
