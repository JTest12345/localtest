...
namespace Samples
{
    ...
    public class COJ_CSV002_01 : COJ
    {
        ...
        public string GetFd_CsvSample()
        {
            ...
            if (ReadCsvSampleCls.ReadTextFileLine(filepath, ref contents, encoding))
            {
                ret += "-------------------------------" + "\r\n";
    ...
    static public class ReadCsvSampleCls
    {
    ...
    /// </summary>
    /// 
    public class COJClassTestforLS
    {
        static void _Main(string[] args)
        {
            ...
            using (var stream = assm.GetManifestResourceStream("Samples.fileContext.cojsample_ls.json"))
            {
