...
public:
	...
	int FinishCnt;
	CButton Bn_msr_Kend;
	double Volume[15];//各剤の計測量を格納する配列20160715
	double NowVolume;
	double Num;//主剤100gに対して、入力されたgの比率を格納
	CString ListC[15][15];//リストコントロール2次元配列20160715
	CString CBVolumeData[15];//20160715
	...
	CEdit Edit_C_msr_LotNo;
	CString Edit_Measure_LotNo;
	CEdit Edit_C_msr_Setubi;
	CString Edit_Measure_Setubi;

	CEdit Edit_C_Target;
	CString Edit_V_Target;
	CStatic m_pict;
};
